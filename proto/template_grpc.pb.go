...
// All implementations should embed UnimplementedAuctionServer
...
// UnimplementedAuctionServer should be embedded to have forward compatible implementations.
...
func (c *replicationClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
...
func (UnimplementedReplicationServer) Update(context.Context, *UpdateRequest) (*UpdateResponse, error) {
...
func _Replication_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReplicationServer).Update(ctx, req.(*UpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
